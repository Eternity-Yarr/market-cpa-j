...
/**
 * 31.07.2014 at 12:50
 * GenericHistoryRepository of market-cpa project
 *
 * @author Dmitry V. (savraz [at] gmail.com)
 */
public class GenericHistoryRepository implements HistoryRepository
{
	final private static Logger log = LoggerFactory.getLogger(GenericHistoryRepository.class);
	private static HistoryRepository instance;

	public static HistoryRepository i()
	{
		if(instance == null)
			instance = new GenericHistoryRepository();
