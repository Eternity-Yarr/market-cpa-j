...
/**
 * 25.07.2014 at 10:47
 * CustomizedBitrixItemRepository of market-cpa project
 *
 * @author Dmitry V. (savraz [at] gmail.com)
 */
public class CustomizedBitrixItemRepository implements ItemRepository
{
	final private static Logger log = LoggerFactory.getLogger(CustomizedBitrixItemRepository.class);
	private static ItemRepository instance;

	public static ItemRepository i()
	{
		if(instance==null)
			instance = new CustomizedBitrixItemRepository();
