...
/**
 * 31.07.2014 at 12:50
 * BitrixDeliveryRepository of market-cpa project
 *
 * @author Dmitry V. (savraz [at] gmail.com)
 */
public class BitrixDeliveryRepository implements DeliveryRepository
{
	final private static Logger log = LoggerFactory.getLogger(BitrixDeliveryRepository.class);
	private static DeliveryRepository instance;

	public static DeliveryRepository i()
	{
		if(instance==null)
			instance = new BitrixDeliveryRepository();
