...
/**
 * 31.07.2014 at 13:16
 * BitrixUserRepository of market-cpa project
 *
 * @author Dmitry V. (savraz [at] gmail.com)
 */
public class BitrixUserRepository implements UserRepository
{
	final private static Logger log = LoggerFactory.getLogger(BitrixUserRepository.class);
	private static UserRepository instance;

	public static UserRepository i()
	{
		if(instance == null)
			instance = new BitrixUserRepository();
